...
- **theme.js**：实现主题系统，能够自动适应系统的深色/浅色模式，包含UI主题更新功能
...
- **扩展无法正常工作**：请确保浏览器已更新至最新版本，并检查扩展是否被禁用。
- **主题切换不生效**：尝试重置主题设置，或手动调整控制面板中的主题选项。
- **评论悬浮窗异常**：检查是否开启了评论功能模块，如有必要可尝试重新加载扩展。
